/* drivers/input/touchscreen/gt968_update.c
 * 
...
void gup_leave_update_mode(void)
{
	...
	gpio_tlmm_config(GPIO_CFG(GTP_INT_PORT, 0,GPIO_CFG_INPUT, GPIO_CFG_NO_PULL,GPIO_CFG_2MA), GPIO_CFG_ENABLE);
    gpio_set_value_cansleep(GTP_INT_PORT, 1);
...
static u8 gup_check_update_file(struct i2c_client *client, st_fw_head* fw_head, u8* path)
{
    ...
    else
    {
        ...
        {
            GTP_ERROR("INVALID header_fw_array, check your gt968_firmware.h file!");
            return FAIL;           
        }
