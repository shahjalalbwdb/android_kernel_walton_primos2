...
#define S(X, Y) ((WCD9XXX_MBHC_CAL_PLUG_TYPE_PTR(tapan_cal)->X) = (Y))
	S(v_no_mic, 30);
//	S(v_hs_max, 2450);//Delete by lichuangchuang for Muitiple Button of Headphone(X825C)SW00024681 2013/12/18
	S(v_hs_max, 2850);//Added by lichuangchuang for Muitiple Button of Headphone(X825C)SW00024681 2013/12/18
#undef S
...
//Added by lichuangchuang for Muitiple Button of Headphone(X825C)SW00024681 2013/12/18 begin
	btn_low[0] = -50;
	btn_high[0] = 150;
	btn_low[1] = 300;
	btn_high[1] = 300;
	...
	btn_low[7] = 750;
	btn_high[7] = 750;
//Added by lichuangchuang for Muitiple Button of Headphone(X825C)SW00024681 2013/12/18 end
