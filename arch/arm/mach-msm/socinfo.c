...
enum {
	...
	//yuquan added begin for yep product begin
       YEP_BOARD_X825A_V1 = 0x10,
       YEP_BOARD_X825B_V1 = 0x20,
       YEP_BOARD_X825C_V1 = 0x30,
	//yuquan added begin for yep product end
...
const char *qrd_hw_platform_subtype[] = {
	...
	//yuquan added begin for yep product begin
	[YEP_BOARD_X825A_V1] = "SKUF",
	[YEP_BOARD_X825B_V1] = "SKUF",
	[YEP_BOARD_X825C_V1] = "SKUF",
	//yuquan added begin for yep product end
